...
class OTPApiService {
  Future<void> sendOtp(String phoneNumber, String countryCode, BuildContext context) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => OtpScreen(number: phoneNumber , countrycode: countryCode,)),
        );
      } else {
