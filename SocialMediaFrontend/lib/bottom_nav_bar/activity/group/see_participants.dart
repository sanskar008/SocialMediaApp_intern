...
class _ParticiapntgrpState extends State<Particiapntgrp> {
  ...
  Future<void> leaveChatroom(String chatRoomId) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        print("Successfully left the chatroom.");
        // You can add navigation or UI updates here
                    ...
                    child: Column(
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          backgroundImage: groupImage.isNotEmpty ? NetworkImage(groupImage) : const AssetImage("assets/avatar/1.png") as ImageProvider,
                          // child: Text(user["name"][0].toUpperCase()),
                        ),
                        Text(
                          "${groupName}",
                          style: TextStyle(color: Color(0xFF7400A5), fontSize: 24.sp, fontWeight: FontWeight.bold),
                        ),
                        SizedBox(height: 8.h),
                        Text(
                          "Members $memberCount",
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(30.0),
                                      side: BorderSide(color: Color(0xFFC08EF9), width: 2.0),
                                    ),
                                    elevation: 0,
                                    padding: EdgeInsets.symmetric(horizontal: 24.0.w, vertical: 4.0.h),
                                  ),
                                  child: Text(
                                    "leave",
                                    style: TextStyle(color: Color(0xFFC08EF9)),
                                  ),
                                  onPressed: () {
          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: Color(0xFFAA5EEA),
...
class ThreeDotsMenuRemove extends StatelessWidget {
  ...
  //   try {
  //     final url = Uri.parse('https://node-service-dev.bondbridge.ai/api/remove-participant');
  //     final userProvider = Provider.of<UserProviderall>(context, listen: false);
  //     final String? token = userProvider.userToken;
  //     // Prepare headers
  //     final headers = {
