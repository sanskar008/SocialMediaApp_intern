...
//             title: Text(
//               user['name'] ?? 'Unknown',
//               style: GoogleFonts.roboto(fontSize: 12.sp, color: Theme.of(context).brightness == Brightness.dark ? AppColors.darkText : AppColors.lightText),
//             ),
//           ),
//         );
//       },
...
//           hintStyle: GoogleFonts.roboto(color: Theme.of(context).brightness == Brightness.dark ? Colors.grey[300] : Colors.grey[800]),
//           prefixIcon: const Icon(Icons.search, color: Colors.grey),
//           filled: true,
//           fillColor: Theme.of(context).brightness == Brightness.dark ? Colors.grey[900] : Colors.grey[300],
...
//                                     : const AssetImage('assets/avatar/4.png') as ImageProvider,
//                               ),
//                               title: Text(
//                                 user['name'] ?? 'Anonymous',
