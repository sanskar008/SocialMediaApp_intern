...
class _AgoraCallServiceState extends State<AgoraCallService> {
  ...
  Future<void> _setupSocketConnection() async {
    ...
    socket!.on('userLeft', (data) {
      ...
      // Handle UI updates if needed when a user leaves
    });
  ...
  Future<void> initAgora() async {
    ...
    setState(() {
      _isInitialized = true; // Update state after successful initialization
    });
  }
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        padding: const EdgeInsets.all(16),
                        decoration: BoxDecoration(
                          color: isSpeakerOn ? Colors.purple : Colors.grey[800],
                          shape: BoxShape.circle,
                        ),
                        child: Icon(
