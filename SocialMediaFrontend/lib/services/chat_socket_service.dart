...
//   void initiateCall(String callId, String userId, String otherId, String type) {
//     if (!_isConnected) {
...
//         {'callId': callId, 'userId': userId, 'otherId': otherId, 'type': type});
//   }
...
class SocketService {
  ...
  void initiateCall(String callId, String userId, List<String> otherId, String type) {
    ...
    socket.emit('callInit',
        {'callId': callId, 'userId': userId, 'otherIds': otherId, 'type': type});
  }
