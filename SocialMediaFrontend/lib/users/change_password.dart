...
class _ChangePassState extends State<ChangePass> {
  ...
  Future<void> _verifyOtp() async {
    ...
    if (response.statusCode == 200) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Center(child: Text("OTP Verified Successfully" , style:  GoogleFonts.poppins(
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => ResetPasswordScreen(phone:_phone.text, countrycode: _selectedCountryCode,)));
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _sendOtp() async {
    ...
    if (response.statusCode == 200) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Center(child: Text('Your OTP is ${responseBody['otp'].toString()}' , style: GoogleFonts.poppins(
            fontSize: 14.sp , fontWeight: FontWeight.bold
          ),) ),
