                ...
                Row(
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        padding:
                            EdgeInsets.symmetric(vertical: 15.5, horizontal: 10),
                        decoration: BoxDecoration(
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(
                        color: Colors.purple, // Change border color
                    ...
                    enabledBorder: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(
                        color: const Color(
                            0xFF740085), // Border color when not focused
                        width: 1,
                      ),
                    ),
                    focusedBorder: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(
                        color: const Color(
                            0xFF740085), // Border color when the field is focused
                        width: 2,
                      ),
                    ),
                  ),
