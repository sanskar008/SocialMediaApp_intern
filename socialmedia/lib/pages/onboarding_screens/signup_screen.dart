              ...
              children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(12), border: Border.all(color: const Color(0xFF7400A5), width: 1.25)
                            ),
                            child: Text(
                              _selectedCountryCode,
                              style: GoogleFonts.montserrat(
                                  fontSize: 16.sp, color: Theme.of(context).brightness == Brightness.dark ? AppColors.darkText : AppColors.lightText),
                            ),
                          ),
                        ),
                        SizedBox(width: 10.w),
                ...
                Center(
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      final SharedPreferences prefs_number =
                    ...
                    child: _isLoading
                        ? SimpleCircularProgressBar(
                            ...
                            backStrokeWidth: 0,
                            progressColors: [Colors.white, Colors.purple],
                          )
                        : Text(
                            'Send OTP',
                            style: GoogleFonts.montserrat(
