...
//                   decoration: BoxDecoration(
//                     color: Theme.of(context).brightness == Brightness.dark ? Colors.purple : AppColors.lightButton,
            ...
            SafeArea(
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(
                    "Let's go",
                    style: GoogleFonts.roboto(color: isDarkMode ? AppColors.lightText : AppColors.darkText, fontSize: 16, fontWeight: FontWeight.bold),
                  ),
                ),
              ),
            ),
